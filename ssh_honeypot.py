...
# SSH Server Class. This simulates an SSH interface to collect login attempts and log user behavior.
...
# Function to simulate a basic shell interface.
...
# This function sets up the TCP listener and spawns a new thread for each incomi
...
# Run honeypot with desired configuration.
if __name__ == '__main__':
    honeypot('0.0.0.0', 2222, 'admin', 'password123')